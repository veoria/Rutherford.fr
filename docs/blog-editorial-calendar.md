...
**Dates (depuis le 22/09/2026) :** la date entre parenthèses est le jeudi de publication. Ne pas traiter un sujet avant sa date : si le premier sujet non coché est daté d'un jeudi ultérieur, ne rien publier ce jour-là et le signaler dans le compte rendu. Les sujets sont validés par FX (liste envoyée sur Asana le 22/09).
