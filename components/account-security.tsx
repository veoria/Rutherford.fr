...
const COPY: Record<Locale, Copy> = {
  ...
  pt: {
    ...
    title: 'Palavra-passe e dois fatores',
    subtitle: 'Faça a gestão da forma como inicia sessão e adicione uma camada de proteção adicional.',
    back: '← Voltar à conta',
    pwTitle: 'Palavra-passe',
    pwDesc: 'Defina ou altere a palavra-passe que usa para iniciar sessão, sem necessidade de ligação por email.',
    pwBtn: 'Alterar palavra-passe',
    tfaTitle: 'Autenticação de dois fatores',
    tfaOn: 'Ativada',
    tfaDescOn: 'Será pedido um código da sua aplicação de autenticação sempre que iniciar sessão com palavra-passe.',
    tfaDescOff: 'Adicione um código de utilização única de uma aplicação de autenticação (Google Authenticator, 1Password, Authy…) para além da sua palavra-passe.',
    enable: 'Ativar dois fatores',
    disable: 'Desativar',
    enrollHint: 'Leia este código QR com a sua aplicação de autenticação e introduza o código de 6 dígitos que aparece.',
    secretHint: 'Não consegue ler? Introduza esta chave manualmente:',
    codeLabel: 'Código de 6 dígitos',
    codePlaceholder: '123456',
    verify: 'Verificar e ativar',
    verifying: 'A verificar…',
    cancel: 'Cancelar',
    enabledMsg: 'A autenticação de dois fatores está ativada.',
