...
const COPY: Record<Locale, CCopy> = {
  ...
  pt: {
    ...
    all: 'Todas',
    search: 'Procurar uma máquina…',
    newValidation: 'Nova validação',
    st: {
      submitted: { short: 'Em análise', long: 'Em análise' },
      in_review: { short: 'Em análise', long: 'Em análise' },
      changes_requested: { short: 'Alterações', long: 'Alterações solicitadas' },
    ...
    ctaDetails: 'Fornecer detalhes',
    mCountry: 'País',
    mCompany: 'Empresa',
    mPress: 'Máquina',
    mRef: 'Referência',
    trackTitle: 'Histórico do processo',
    tlSubmitted: 'Pedido submetido',
    tlReview: 'Em análise pela equipa Rutherford',
    tlReviewSub: 'verificação do perfil ICC e das condições da máquina',
    tlValidated: 'Perfil validado',
    tlValidatedSub: 'conforme, máquina pronta a ligar',
    tlEligible: 'Elegível para ligar',
    tlEligibleSub: 'Último passo, ligue a máquina para ativar o controlo em closed-loop.',
    tlChanges: 'Alterações solicitadas',
    tlChangesSub: 'São necessários alguns detalhes antes de continuar.',
    tlRejected: 'Não elegível',
    tlRejectedSub: 'Esta máquina não é atualmente suportada para o closed-loop.',
    convTitle: 'Conversa',
    ...
    promptStrong: 'Complete o seu perfil',
    promptText: 'adicione o seu nome, empresa e função para um apoio adaptado e um contacto mais rápido.',
    emptyText: 'Ainda não tem pedidos de validação de consola.',
    emptyCta: 'Iniciar uma validação de consola',
  },
};
