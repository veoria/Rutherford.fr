...
const COPY: Record<Locale, TeamCopy> = {
  ...
  pt: {
    ...
    you: 'Você',
    active: 'Ativo',
    pendingPill: 'Pendente',
    invitedOn: (d) => `Convidado a ${d}`,
    roleOwner: 'Proprietário',
    roleAdmin: 'Administrador',
    roleMember: 'Membro',
    note: 'Os administradores podem convidar membros, gerir as funções e o acesso às validações de consola e à Academy.',
    emailPh: 'nome@empresa.com',
    send: 'Enviar convite',
    sending: 'A enviar…',
    cancel: 'Cancelar',
    inviteError: 'Não foi possível enviar o convite. Verifique o endereço e tente novamente.',
    makeAdmin: 'Tornar administrador',
    makeMember: 'Tornar membro',
    remove: 'Remover da equipa',
    revoke: 'Cancelar convite',
    actions: 'Ações do membro',
  },
};
