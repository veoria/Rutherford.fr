...
const COPY: Record<Locale, Copy> = {
  ...
  pt: {
    ...
    body: [
      ...
      { text: 'gestão de cor em offset e flexografia', accent: true },
      { text: '. ' },
      { text: 'Parceiros X-Rite PANTONE', accent: true },
      { text: ', acompanhamos impressores, transformadores e marcas em ' },
      { text: 'mais de 30 países', accent: true },
      { text: ', com ' },
      { text: 'mais de 1.000 sistemas implementados em todo o mundo', accent: true },
      { text: '.' },
    ],
