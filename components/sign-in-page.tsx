...
// Matches production: real Supabase auth. Flip to true (or wire
// NEXT_PUBLIC_AUTH_DEMO) to walk the UI in demo mode without real auth.
...
const COPY: Record<Locale, SignInCopy> = {
  ...
  pt: {
    ...
    toSignup: 'Novo por aqui? Crie uma conta',
    toSignin: 'Já tem uma conta? Inicie sessão',
    magicInstead: 'Enviar-me antes uma ligação de acesso por email',
    needEmail: 'Introduza primeiro o seu endereço de email.',
    resetSent: 'Verifique a sua caixa de entrada: enviámos-lhe uma ligação para repor a palavra-passe.',
    confirmSent: 'Quase pronto. Verifique a sua caixa de entrada para confirmar o seu email e depois inicie sessão.',
    inboxBefore: 'Verifique a sua caixa de entrada em ',
    inboxFallback: 'o seu endereço',
    inboxAfter: '. A ligação de acesso expira dentro de 1 hora.',
    tfaPrompt: 'Introduza o código de 6 dígitos da sua aplicação de autenticação.',
    codeLabel: 'Código de 6 dígitos',
    codePlaceholder: '123456',
    verify: 'Verificar',
    ...
    pwHint: 'Pelo menos 8 caracteres.',
    confirmTitle: 'Verifique o seu email',
    confirmBefore: 'Enviámos uma ligação de confirmação para ',
    confirmAfter: '. Clique nela para ativar a sua conta. Depois ajudamo-lo a completar o seu perfil.',
    linkTitle: 'Ligação de acesso enviada',
    resetTitle: 'Ligação de reposição enviada',
    back: '← Voltar',
  },
};
