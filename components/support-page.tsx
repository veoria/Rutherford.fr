...
const COPY: Record<Locale, Copy> = {
  ...
  pt: {
    ...
    reassure: ['Equipa de especialistas', 'Resposta em 1 dia útil', 'Ligação apenas com a sua autorização', 'Sem compromisso'],
    formTitle: 'Como podemos ajudar?',
    signedInPrefix: 'Sessão iniciada como',
    loginPrompt: 'Tem uma conta Rutherford? Inicie sessão para preencher os seus dados.',
    emailLabel: 'E-mail',
    emailPh: 'nome@exemplo.com',
    companyLabel: 'Empresa',
    companyPh: 'A sua empresa',
    anydeskLabel: 'Número de suporte AnyDesk',
    anydeskPh: 'ex. 123 456 789',
    countryLabel: 'País',
    countryPlaceholder: 'Selecione o seu país',
    subjectLabel: 'Assunto',
    subjectPh: 'Resumo breve do problema',
    anydeskHelpTitle: 'O que é o AnyDesk?',
    anydeskHelp:
      'O AnyDesk permite à nossa equipa ver o seu ecrã para o ajudar mais depressa. Descarregue-o gratuitamente em anydesk.com, abra-o e copie o endereço de 9 dígitos apresentado em « Este posto ». A ligação só começa quando a aceita na sua máquina.',
    problemLabel: 'Explique o seu problema',
    problemPh:
      'O que acontece, em que máquina de impressão / software e desde quando? Pode escrever na sua língua. O inglês ajuda-nos a responder mais depressa.',
    photosTitle: 'Adicione fotos (opcional)',
    dropHint: 'Tire uma foto ou arraste para aqui',
    photoAdded: 'Foto adicionada',
    replace: 'Substituir',
    photoCards: [
      { title: 'Ecrã completo', desc: 'Uma foto de todo o ecrã, não apenas de um pormenor.' },
      { title: 'Mensagem de erro', desc: 'Se aparecer uma caixa de erro vermelha, toque nela e capture a mensagem.' },
      { title: 'Qualquer outra coisa', desc: 'Qualquer foto adicional que nos ajude a compreender mais depressa.' },
    ],
    submit: 'Enviar o pedido',
    sending: 'A enviar…',
    submitHint: 'Compatível com telemóvel. Tire e envie as fotos diretamente do seu telemóvel.',
    errFields: 'Preencha os campos obrigatórios (e-mail, assunto e descrição).',
    errGeneric: 'Ocorreu um erro, tente novamente.',
    nextTitle: 'E depois?',
    nextSteps: [
      'A nossa equipa analisa o seu pedido e as suas fotos.',
      'Entramos em contacto e a ligação AnyDesk só se faz com a sua autorização.',
      'Acompanhamos até estar resolvido. Acompanhe tudo a partir da sua conta.',
    ],
    faqTitle: 'Perguntas frequentes',
    faq: [
      {
        q: 'O que é o AnyDesk e é seguro?',
        a: 'O AnyDesk é uma ferramenta de acesso remoto que permite à nossa equipa ver o ecrã da sua consola para o ajudar mais depressa. A ligação só começa quando a aceita na sua máquina e pode terminá-la a qualquer momento. Gratuito em anydesk.com.',
      },
      {
        q: 'Onde encontro o meu número AnyDesk?',
        a: 'Abra o AnyDesk no computador da consola. O seu endereço de 9 dígitos aparece em « Este posto ». Copie-o para o formulário.',
      },
      {
        q: 'Em quanto tempo respondem?',
        a: 'Respondemos no prazo de um dia útil, normalmente muito antes. Guarde a referência do seu pedido para qualquer acompanhamento.',
      },
      {
        q: 'Posso acompanhar o meu pedido?',
        a: 'Sim. Com uma conta Rutherford, cada pedido e o respetivo estado aparecem em A minha conta → Suporte, e enviamos-lhe um e-mail sempre que o estado muda.',
      },
    ],
    successTitle: 'Obrigado pelo seu pedido.',
    successRefPre: 'Referência do seu pedido',
    successBody: 'Enviámos-lhe uma confirmação por e-mail. A nossa equipa responder-lhe-á o mais depressa possível.',
    copyLabel: 'Copiar',
    copiedLabel: 'Copiado',
    trackCta: 'Acompanhar o meu pedido',
    backHome: 'Voltar a rutherford.fr',
  },
};
